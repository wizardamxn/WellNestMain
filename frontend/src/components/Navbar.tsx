...
export default function Navbar() {
  ...
  return (
    <>
      <nav data-testid="navbar" className="fixed top-0 left-0 right-0 bg-card/80 backdrop-blur-md border-b border-border z-50">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Select value={language} onValueChange={setLanguage}>
                <SelectTrigger data-testid="select-language" className="w-auto border-none bg-transparent text-sm">
                    ...
                    >
                      <Avatar className="w-6 h-6">
                        <AvatarFallback className="bg-primary text-primary-foreground text-xs">
                          {user?.preferredName ? user.preferredName[0].toUpperCase() : user?.username[0].toUpperCase() || 'U'}
                        </AvatarFallback>
                      </Avatar>
      ...
      <div className="fixed top-16 left-0 right-0 bg-destructive text-destructive-foreground p-3 text-center text-sm z-40 hidden" id="emergency-banner">
